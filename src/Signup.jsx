                ...
                <div className="container-login100 ">
                    <div className="wrap-login100 p-5 p-l-55 p-r-55 p-t-65 p-b-54">
                        <form className="login100-form validate-form">
                            ...
                            <div className="wrap-input100 validate-input m-b-23" data-validate="Username">
                            ...
                            <div className="wrap-input100 validate-input m-b-23" data-validate="Mail Address">
                                <span className="label-input100">Username</span>
                                <input className="input100" type="mail" name="username" placeholder="Type your Mail" />
                                {/* <span className="focus-input100" data-symbol="&#xf206;"></span> */}
                                <span className="focus-input100" style={{ marginTop: "36px", marginLeft: "15px" }} ><i style={{ fontSize: "20px" }}><BiLogoGmail /></i></span>
                            </div>
